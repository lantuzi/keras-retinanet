...
def assert_keras_version():
	...
	requried = '.'.join(map(str, minimum_keras_version))
	assert(keras_version_ok()), 'You are using keras version {}. The minimum required version is {}.'.format(detected, requried)
